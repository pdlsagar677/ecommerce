...
import { Package, Calendar, CreditCard, Truck, MapPin, User, FileText } from "lucide-react";
            ...
            <Card className="rounded-2xl shadow-lg border-0 bg-white">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold">${(orderDetails?.totalAmount * 0.1).toFixed(2)}</span>
                </div>
                <Separator />
                <div className="flex justify-between text-lg font-bold">
                  <span>Total</span>
                  <span className="text-orange-600">
                    ${((orderDetails?.totalAmount || 0) * 1.1).toFixed(2)}
                  </span>
                </div>
              </CardContent>
            </Card>
